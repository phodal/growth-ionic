...
import {Transition, Animation, PageTransition} from "ionic-angular";
...
export class BodyContentInTransition extends PageTransition {
  init() {
    super.init();
...
export class BodyContentOutTransition extends PageTransition {
  init() {
    super.init();
