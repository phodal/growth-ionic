angular.module('starter', ['ionic', 'ngCordova', 'app.helloWorldController', 'app.reviewController', 'app.dayController', 'starter.controllers', 'starter.services', 'hc.marked', 'ionic.rating'])
