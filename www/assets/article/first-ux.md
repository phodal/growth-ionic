...
![UX Design](./assets/article/images/ux/ux_design.jpg)
...
![Search Phodal](./assets/article/images/ux/search-phodal.jpg)
...
![Lean](./assets/article/images/ux/lean.jpg)
...
![UX](./assets/article/images/ux/layer.jpg)

这时候就需要尽量往可用靠拢。怎样对两者进行一个简单的划分？

下图就是实用的软件：

![IE Alert](./assets/article/images/ux/ie-alert.jpg)

而下图就便好一点了：

![jQuery Popup](./assets/article/images/ux/popup.jpg)
...
![用户体验要素](./assets/article/images/ux/ux-elements.png)
